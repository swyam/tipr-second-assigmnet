...
if dataset=="MNIST":
    if flag1==1:
                    ...
                    file2='scalar1'
                    images=glob.glob("/home/swyam/tipr2/MNIST/0/*.jpg")
                    ...
                    for image in images:
                        ...
                        x.append(img.tolist())
                        y.append(0)
                    images=glob.glob("/home/swyam/tipr2/MNIST/1/*.jpg")
                    ...
                    for image in images:
                        ...
                        x.append(img.tolist())
                        y.append(1)
                    images=glob.glob("/home/swyam/tipr2/MNIST/2/*.jpg")
                    ...
                    for image in images:
                        ...
                        x.append(img.tolist())
                        y.append(2)
                    images=glob.glob("/home/swyam/tipr2/MNIST/3/*.jpg")
                    ...
                    for image in images:
                        ...
                        x.append(img.tolist())
                        y.append(3)
                    images=glob.glob("/home/swyam/tipr2/MNIST/4/*.jpg")
                    ...
                    images=glob.glob("/home/swyam/tipr2/MNIST/5/*.jpg")
                    ...
                    for image in images:
                        ...
                        x.append(img.tolist())
                        y.append(5)
                    images=glob.glob("/home/swyam/tipr2/MNIST/6/*.jpg")
                    ...
                    for image in images:
                        ...
                        x.append(img.tolist())
                        y.append(6)
                    images=glob.glob("/home/swyam/tipr2/MNIST/7/*.jpg")
                    ...
                    for image in images:
                        ...
                        x.append(img.tolist())
                        y.append(7)
                    images=glob.glob("/home/swyam/tipr2/MNIST/8/*.jpg")
                    ...
                    for image in images:
                        ...
                        x.append(img.tolist())
                        y.append(8)
                        images=glob.glob("/home/swyam/tipr2/MNIST/9/*.jpg")
    ...
    if flag2==1:
                            ...
                            for image in images:
                                ...
                                data_x=x
                                net=pickle.load(open("final_modelmnist",'rb'))
                                #theta=pickle.load(open("thetas",'rb'))
